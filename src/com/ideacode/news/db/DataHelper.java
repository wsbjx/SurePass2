...
public class DataHelper
{
    ...
    {
        int code = 0;
        Cursor cursor = db.query(SqliteHelper.TB_USER_PRAISE_BELITTLE, null, TableUserPraiseBelittleEntity.USERID
                        + " = ? and " + TableUserPraiseBelittleEntity.MOODID + " = ? and "
                        + TableUserPraiseBelittleEntity.USEROPTIONTYPE + " = ? ", new String[] {
                        String.valueOf(userId), String.valueOf(moodId), String.valueOf(userOptionType) }, null, null,
                        null);
        ...
        else
        {
            ...
            Long resultId = db.insert(SqliteHelper.TB_USER_PRAISE_BELITTLE,
                            TableUserPraiseBelittleEntity.USEROPTIONTYPE, values);
