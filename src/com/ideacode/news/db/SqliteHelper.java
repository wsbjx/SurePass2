...
public class SqliteHelper extends SQLiteOpenHelper
{
    ...
    {
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TB_USER_PRAISE_BELITTLE + "(" + TableUserPraiseBelittleEntity._ID
                        + " integer primary key," + TableUserPraiseBelittleEntity.USERID + " integer,"
                        + TableUserPraiseBelittleEntity.MOODID + " integer,"
