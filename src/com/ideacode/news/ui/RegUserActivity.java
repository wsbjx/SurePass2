...
public class RegUserActivity extends IdeaCodeActivity
{
    ...
    private EditText            reg_user_edit, reg_email_edit, reg_birthday_edit, reg_password_edit,
                    reg_password2_edit;
    ...
    private final RadioGroup.OnCheckedChangeListener groupChangeListener = new RadioGroup.OnCheckedChangeListener()
                                                                         {
                                                                                             ...
                                                                                             int checkedId)
                                                                             {
                                                                                 ...
                                                                                 RadioButton rb = (RadioButton) RegUserActivity.this
                                                                             ...
                                                                             public void onClick(View view)
                                                                             {
                                                                                 ...
                                                                                 switch(view.getId())
                                                                                 {
                                                                                     ...
                                                                                     case R.id.main_head_save_button:
                                                                                         if("".equals(reg_user_edit
                                                                                                         .getText()
                                                                                                         .toString())
                                                                                                         || "".equals(reg_email_edit
                                                                                                                         .getText()
                                                                                                                         .toString())
                                                                                                         || "".equals(reg_birthday_edit
                                                                                                                         .getText()
                                                                                                                         .toString())
                                                                                                         || "".equals(reg_password_edit
                                                                                                                         .getText()
                                                                                                                         .toString())
                                                                                                         || "".equals(reg_password2_edit
                                                                                                                         .getText()
                                                                                                                         .toString()))
                                                                                         {
                                                                                             UIHelper.ToastMessage(
                                                                                                             RegUserActivity.this,
                                                                                                             R.string.regEmptyError);
                                                                                             return;
                                                                                         }
                                                                                         if(StringUtils.checkUsernameInput(reg_user_edit
                                                                                                         .getText()
                                                                                                         .toString()))
                                                                                         {
                                                                                             if(StringUtils.checkEmailInput(reg_email_edit
                                                                                                             .getText()
                                                                                                             .toString()))
                                                                                             {
                                                                                                 if(StringUtils.check2Password(
                                                                                                                 reg_password_edit
                                                                                                                                 .getText()
                                                                                                                                 .toString(),
                                                                                                                 reg_password2_edit
                                                                                                                                 ...
                                                                                                                                 .toString()))
                                                                                                 {
                                                                                                     ...
                                                                                                     tbUser.setUserId(Long
                                                                                                                     .parseLong(StringUtils
                                                                                                                                     .date2UserId()));
                                                                                                     tbUser.setUserBirthday(StringUtils
                                                                                                                     .toDate2(reg_birthday_edit
                                                                                                                                     .getText()
                                                                                                                                     .toString()));
                                                                                                     tbUser.setUserName(reg_user_edit
                                                                                                                     .getText()
                                                                                                                     .toString());
                                                                                                     tbUser.setUserEmail(reg_email_edit
                                                                                                                     .getText()
                                                                                                                     .toString());
                                                                                                     tbUser.setUserSex(sex);
                                                                                                     tbUser.setUserPassword(MD5
                                                                                                                     .MD5Encode(reg_password2_edit
                                                                                                                                     .getText()
                                                                                                                                     .toString()));// 通过MD5加密
                                                                                                     tbUser.setUserLogintime(StringUtils
                                                                                                                     .genCurrentDate());
