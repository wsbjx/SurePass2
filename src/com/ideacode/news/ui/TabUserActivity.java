...
/**
 * MySpace(我的空间) 2013-4-22下午5:25:51
 */
public class TabUserActivity extends IdeaCodeActivity
{
    ...
    // 用户信息相关对象声明
    private static TextView                username_tv, useremail_tv, usersex_tv, userlocation_tv, usersummary_tv,
                    birthday_tv, qq_tv;
                                                      ...
                                                      public void onClick(View v)
                                                      {
                                                          switch(v.getId())
                                                          {
                                                              ...
                                                              case R.id.submit_bt:
                                                                  ...
                                                                  tbUser.setUserSummary(usersummary_tv.getText()
                                                                                  .toString());
                                                                  tbUser.setUserBirthday(StringUtils
                                                                                  .toDate2(birthday_tv.getText()
                                                                                                  .toString()));
                                                                  ...
                                                                  mBundle.putSerializable(CommonSetting.FileNameTag,
                                                                                  tbUser);
                                                                  intent.putExtras(mBundle);
                                                                  intent.setClass(TabUserActivity.this,
    ...
    protected Dialog onCreateDialog(int id)
    {
        ...
        switch(id)
        {
            ...
            case LOCATION_PICK_DIALOG:
                ...
                customBuilder.setTitle(this.getResources().getString(R.string.locationDialogTitle))
                                .setNegativeButton("取消", negativeButtonClickListener)
    ...
    {
        if(!tbUser.getUserName().equals(username_tv.getText().toString())
                        || !tbUser.getUserEmail().equals(useremail_tv.getText().toString())
                        || !tbUser.getUserSummary().equals(usersummary_tv.getText().toString())
                        || !tbUser.getUserQQ().equals(qq_tv.getText().toString())
                        || !tbUser.getUserSex().equals(usersex_tv.getText().toString())
                        || !StringUtils.date2String(tbUser.getUserBirthday()).equals(birthday_tv.getText().toString())
                        || provinceid != CommonSetting.ids[0] || cityid != CommonSetting.ids[1])
        {
        ...
        {
            if((provinceid == CommonSetting.ids[0] && provinceid != -1)
                            || (cityid == CommonSetting.ids[1] && cityid != -1))
            {
                userlocation_tv.setText(CommonSetting.provinces[CommonSetting.ids[0]].getName() + "  "
                                + CommonSetting.cities[CommonSetting.ids[0]][CommonSetting.ids[1]].getName());
            }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(moodList.size() < AppContext.PAGE_SIZE)
                        {
                            ...
                            NewDataToast.makeText(this, getString(R.string.new_data_toast_message, lvMoodData.size()))
                                            .show();
                        }
                        else
                        {
            ...
            case TaskType.TS_EXAM_SEARCH_USER_MOOD_MORE:
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        ListViewUserMoodAdapter resultadapter = (ListViewUserMoodAdapter) listAdapter
                                        .getWrappedAdapter();
                    ...
                    else
                    {
                        ...
                        if(provinceid != -1 && cityid != -1)
                        {
                            userlocation_tv.setText(CommonSetting.provinces[tbUser.getUserProvinceId()].getName()
                                            + "  "
                                            + CommonSetting.cities[tbUser.getUserProvinceId()][tbUser.getUserCityId()]
                                                            .getName());
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(newsList.size() < AppContext.PAGE_SIZE)
                        {
                            ...
                            NewDataToast.makeText(this, getString(R.string.new_data_toast_message, lvNewsData.size()))
                                            .show();
                        }
                        else
                        {
