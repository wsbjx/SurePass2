...
public class TabMoodActivity extends IdeaCodeActivity
{
                                                      ...
                                                      public void onClick(View v)
                                                      {
                                                          ...
                                                          switch(v.getId())
                                                          {
                                                              ...
                                                              case R.id.main_head_addmood_button:
                                                                  ...
                                                                  {
                                                                      Intent intent = new Intent(TabMoodActivity.this,
                                                                                      AddMoodActivity.class);
                                                                      TabMoodActivity.this.startActivityForResult(
                                                                                      intent, 0);
                                                                  }
                                                                  else
                                                                  {
    ...
    public void doPraise(View view)
    {
        ...
        if(appContext.isLogin())
        {
            ...
            int code = datahelp.addUserPraiseBelittle(appContext.getLoginUid(), mood.getMoodId(),
                            UserOptionType.ADD_PRAISE);
