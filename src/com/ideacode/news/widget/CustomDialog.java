 ...
 * use your own look & feel. Under GPL v3 : http://www.gnu.org/licenses/gpl-3.0.html
 *
            ...
            if(positiveButtonText != null)
            {
                ...
                if(positiveButtonClickListener != null)
                {
                    ((Button) layout.findViewById(R.id.positiveButton)).setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        {
                            positiveButtonClickListener.onClick(dialog, DialogInterface.BUTTON_POSITIVE, provinceid,
                                            cityid);
