...
final public class XmlParser
{
     ...
     * @return
     */
    public static List<ProvinceEntity> getProvinces(InputStream in) throws ParseException, SAXException, IOException
    {
    ...
    /**
     * 执行Provinces解析的类 SAX引擎对XML文件解析时，采用这种方式进行解析：遇到标签时就回调startElement()方法; 当遇到标签结束时，就回调endElement()方法。
     * 
